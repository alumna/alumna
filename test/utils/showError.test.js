...
test('showError - error on Altiva main app compilation', () => {
	...
	expect( console.log.mock.calls[ 0 ][ 0 ] ).toBe( '[Altiva generated code error] Test Error in /path/component.html: Message from error' );
});